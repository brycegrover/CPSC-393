...
Divison of Labor:
- Bryce:
    - Wrote code in full for model that forecasts future race results for Olympic Games using hostorical Olympic data. (Finished_OlympicModel.ipynb)
    - Wrote code in full for model that forecasts future race results for Bryce and Jason using their personal swim career stats. (Finished_Predict_BG+JK_100Fr.ipynb)
    - Wrote code in part for model that forecasts in which month Bryce and Jason will have the best swim race performances in a year. (Finished_Predict_BG+JK_Month.ipynb)
    - Wrote the Final Report in full.
- Jason:
    - Wrote code in part for model that forecasts in which month Bryce and Jason will have the best swim race performances in a year. (Finished_Predict_BG+JK_Month.ipynb)